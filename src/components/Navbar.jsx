  ...
  return (
    <div className="flex flex-col items-start justify-between w-full pt-2 px-4 z-[9999]">
      ...
      <div className="flex flex-col items-center gap-2 w-full mt-4">
        ...
        <h3 className="text-[16px] !font-medium !text-[var(--text-conqr)]">This demo showcases some of Conqr Words Add-in AI features. Try it out by typing a word in the text editor.</h3>
      </div>
    </div>
  );
};
